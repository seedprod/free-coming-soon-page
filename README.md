...
<body>
	<div id="cspio-page">
		<div id="cspio-content">
			...
			<img id="cspio-logo" src="https://static.comingsoonpage.com/69/GVPCdRdQPamH4uYpEAbl_seedprod-logo-white.png">
			    				
			<h1 id="cspio-headline">Coming Soon Page</h1>			    				
			
			<div id="cspio-description">Get ready! Something really cool is coming!</div>			    				
			
			<form id="cspio-form" action="https://www.comingsoonpage.com/v1/subscribe?69" method="post">
			...
			<div id="cspio-credit">
					<span><a target="_blank" href=""><img id="aff" src="http://wordpress.dev/wp-content/plugins/seedprod-coming-soon-pro-5/template/images/seedprod-credit.png" class="img-responsive"></a>
				</span></div>
